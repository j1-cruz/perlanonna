  ...
  <div className="row">
    <div className="col-sm-6">
      <ul className="list-group">
        ...
        <Link to="#tophits" type="button" className="btn btn-outline-danger         text-dark font-weight-bold mb-1">13:00 a 14:30 hs   Top Hits
        </Link>
        <Link to="#elexpresso" type="button" className="btn btn-outline-danger         text-dark font-weight-bold mb-1">14:30 a 16:00 hs   El Expresso
        </Link>
        ...
        <Link to="#fm100" type="button" className="btn btn-outline-danger text-dark font-weight-bold mb-1">20:00 a 07:00 hs  FM 100
        </Link>
      </ul>
    </div>
    ...
    <div className="col-sm-6">
    <ul className="list-group">
        <h5 className="list-group-item bg-warning text-white text-center">Sábado</h5>
        ...
        <Link to="#hablandoclaro" type="button" className="btn btn-outline-warning text-dark font-weight-bold mb-1">10:30hs a 12:00hs Hablando claro
        </Link>
        <Link to="#notorius" type="button" className="btn btn-outline-warning text-dark font-weight-bold mb-1">17:00hs a 20:00hs Notorious
        </Link>
      </ul>
      <ul className="list-group">
