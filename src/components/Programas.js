        ...
        <Row id="de7a8" className="bg-brown borderprogram">
          <Col md="6">
            <h2 className="text-white ml-2 mt-2">"De 7 a 8"</h2>
				...
				<h5 className="text-white ml-2 rubik"> Empezas tu día y          Martín junto al Galleg,
		      ...
		      <Col md="6" className="order-md-2">
		        <h2 className="text-white mt-2 ml-2">Manos a la obra</h2>
				    ...
				    actual.
                        ...
                        <li className="ml-2 text-white">Conduccion: Fransisco Álvarez de Toledo</li>
        ...
        <Row id="hablandoclaro" className="bg-3 mt-2 borderprogram">
		  <Col className="col-md-6">
		      <h2 className="text-white mt-2 ml-1"> Hablando claro </h2>
                <h4 className="text-white ml-1"> Sabado 10:30hs a 12:00hs
				</h4>
				<h5 className="text-white ml-1">
		          ...
		          <li className="ml-2 text-white">Conduccion: José "gallego" Calvo </li>
				  <li className="ml-2 text-white">Operación técnica: Santiago Brescia</li>
				</Col>
		          <Col md="6">
            ...
            <Col md="6" className="order-md-2">
	           <h2 className="text-white mt-2 ml-2">Notorious</h2>
	            ...
	            <p className="text-white ml-2"> Conductora: Gabriela Ganim</p>
	          </Col>
	          <Col md="6">
	            <img className="d-none d-lg-flex" height={300} width={490}src="assets/images/programas/onair.jpeg" alt="Notorius" />
                <img
            ...
            <Col md="6">
				<h2 className="text-white mt-2 ml-2">Un espacio para vos</h2>
				    ...
				    <h5 className="text-white ml-2">
				        ...
				        <li className="ml-2 text-white">Conduccion: Ana Maria Carabetta </li>
				        <li className="ml-2 text-white">Operación técnica: Santiago Brescia</li>
				</Col>
				<Col md="6">
        ...
        <Row id="2x4" className="bg-5 mt-2 borderprogram2">
            <Col className="order-md-2">
				<h2 className="text-white mt-2 ml-2">2x4</h2>
				    ...
				    <li className="ml-2 text-white">Conduccion: Oscar De Dios</li>
                    <li className="ml-2 text-white">Operación técnica: Santiago Brescia</li>
				</Col>
				<Col md="6" className="order-md-1">
